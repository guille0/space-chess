...
std::vector<std::pair<std::vector<int>,std::vector<int>>> Board::possibleMoves() {
  ...
  for (auto piece : pieces) {
    ...
    std::vector<std::pair<std::vector<int>,std::vector<int>>> moves = pieceMoves(piece);
...
std::vector<std::pair<std::vector<int>,std::vector<int>>> Board::pieceMoves(std::vector<int> t_piece) {
  ...
  moves::Moves Movement(this, x, y, z);

  switch (abs(pieceType)) {
    case 1: {
      // Gets pawn2step, turn from this Board object
...
Board::allowedMoves(std::vector<std::pair<std::vector<int>,std::vector<int>>> piecesAndMoves) {
